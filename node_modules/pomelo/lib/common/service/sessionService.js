...
Session.prototype.send = function(msg) {
    if(!!this.__socket__.__desSecret){
        msg = desTool.cipher(this.__socket__.__desSecret, msg.toString());
    }
...
Session.prototype.sendBatch = function(msgs) {
    if(!!this.__socket__.__desSecret){
        for (var i = 0; i < msgs.length; i++) {
            msgs[i] = desTool.cipher(this.__socket__.__desSecret, msg[i].toString());
        }
    }
